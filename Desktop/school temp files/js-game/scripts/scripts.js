// Nicole Logan - BCIT FWD40 
// JS Game for Scripting 1
// All notes in the file are mine own for the purpose of reminding myself of what things are for, but also to break down my steps for the game logic
// References for the game logic are from the following sources:
...
document.addEventListener("DOMContentLoaded", () => {
    if (launchScreen) {
        ...
        launchScreen.style.textAlign = "center";
...
function gameOver(status) {
    ...
    if (status === "Win") {
        const continuePlaying = confirm("Congrats, you won! Do you want to continue playing?");

        if (continuePlaying) {
            console.log("Player chose to continue playing.");
        } else {
            console.log("Player chose not to continue. Returning to launch screen.");
            resetGame(); //
            gameScreen.style.display = "none";
            launchScreen.style.display = "block";
        }
...
// For updating the colors of the grid tiles & their internal numbers
